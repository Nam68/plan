	      ...
	      <div class="modal-content shadow p-3 mb-5 bg-body rounded">
	        <div class="modal-header row">
	          <div class="modal-title col">
	            <input type="text" class="form-control" placeholder="Please Write a Title...">
	          </div>
	          <div class="col">
	            <input id="albumAddDate" class="flatpickr form-control" type="text" placeholder="Select Date.." data-id="range">
				<script>
					var startdate;
					var enddate;
					$(".flatpickr").flatpickr(
	          ...
	          <div class="row">
		        <div class="col-sm">
				  <div id="carouselCaptions" class="carousel slide" data-bs-ride="carousel" data-bs-touch="false" data-bs-interval="false">
				    ...
				    <div class="carousel-inner" id="album-carousel-inner">
				  	  <div class="carousel-item active" role="button" id="addAlbumIcon">
		        ...
		        <div class="col-sm container">
		      	  <div class="row row-cols-2 pt-1 mb-1 text-start" id="albumInfo">
		      		...
		      		<div class="mb-2">
		      		  <span>出発日：</span>
		      		  <span><input id="albumContentStartdate" type="text" role="button" style="width: 15vh;"></span>
		      		</div>
		      		<div>
		      		  <span>作成者：</span>
		      		...
		      		<div>
		      		  <span>到着日：</span>
		      		  <span><input id="albumContentEnddate" type="text" role="button" style="width: 15vh;"></span>
		      		</div>
		      	  </div>
		      	  <script>
					/**
					...
					*/
		      	  ...
		      	  <hr>
		      	  <div class="row mt-1 ms-1" id="albumContent">
